...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Koneksi READ-ONLY ke database cashless_ibs (sistem IBS)
        'ibs' => [
            'driver'    => 'mysql',
            'host'      => env('IBS_DB_HOST', '127.0.0.1'),
            'port'      => env('IBS_DB_PORT', '3306'),
            'database'  => env('IBS_DB_DATABASE', 'cashless_ibs'),
            'username'  => env('IBS_DB_USERNAME', 'root'),
            'password'  => env('IBS_DB_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset'   => 'utf8mb4',
